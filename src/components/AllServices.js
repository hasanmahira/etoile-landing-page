  ...
  return (
    <div className="flex">
      <div className="w-1/2 p-5 text-white">
        <p>Web sitesi tasarımı hizmetimizle, markanızın dijital yüzünü en etkili şekilde yansıtacak modern ve kullanıcı dostu web siteleri oluşturuyoruz.</p>
      </div>
      <div className="w-1/2">
        {servicesData.map((service, index) => (
          <div key={index} className="border-b border-gray-700 p-3">
            ...
            {activeService === index && (
                <div className="bg-black text-neon-blue shadow-neon p-5 rounded">
