...
export const DREAMS_LIVE = 'Firmanızın pazarlama ve reklam ihtiyaçlarını karşılamak için buradayız. 360 ° Ajans hizmetimizle, tasarımdan sosyal medya yönetimine, reklam çalışmalarından marka yönetimine kadar geniş bir yelpazede çözümler sunuyoruz. Sizin için en iyi stratejileri belirleyerek, markanızı dünyaya duyurmak için buradayız.'
...
export const HTML_WEB_DESIGN = 'HTML tabanlı web tasarımı ile hızlı ve etkili çözümler sunuyoruz. Basit ve esnek yapısıyla, ihtiyaçlarınıza uygun özelleştirmeler yapabiliyoruz.';
export const ASP_NET_WEB_DESIGN = 'Güçlü ve dinamik ASP.Net platformunu kullanarak, performansı yüksek ve güvenilir web siteleri geliştiriyoruz. Büyük ölçekli projeler için ideal çözümler sunuyoruz.';
export const LANDING_PAGE_DESIGN = 'Dönüşüm odaklı landing page tasarımlarımız ile ziyaretçilerinizi müşteriye dönüştürüyoruz. Hedef kitlenize hitap eden etkili sayfalar oluşturuyoruz.';
export const CORPORATE_WEB_DESIGN = 'Şirketinizin itibarını ve profesyonelliğini yansıtan kurumsal web siteleri tasarlıyoruz. Markanızı en iyi şekilde temsil eden tasarımlar sunuyoruz.';
export const ECOMMERCE_WEB_DESIGN = 'Satışlarınızı artıracak e-ticaret web siteleri geliştiriyoruz. Kullanıcı dostu arayüzler ve güvenli ödeme sistemleri ile müşteri memnuniyetini hedefliyoruz.';
